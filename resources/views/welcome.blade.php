<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
            <div class="chronomots-heading-stack">
                <p class="chronomots-heading-eyebrow">Accueil</p>
    ...
    <div class="px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.12fr_0.88fr] lg:items-start">
            <section class="chronomots-panel chronomots-hero-panel rounded-[2rem] p-6 sm:p-8">
                <span class="chronomots-badge">Chronomots</span>
                <h2 class="chronomots-display-title mt-6 text-4xl font-black leading-tight tracking-[-0.07em] text-slate-950 sm:text-5xl">
                    Le jeu éducatif qui fait progresser en lettres et en chiffres.
                </h2>
                <p class="chronomots-lead mt-5 max-w-2xl text-base leading-8 text-slate-600">
                ...
                <div class="mt-10 rounded-[2rem] border border-white/70 bg-white/12 p-5 shadow-sm shadow-slate-100 backdrop-blur-sm sm:p-6">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <p class="text-sm font-semibold uppercase tracking-[0.22em] text-slate-500">Compétences explorées</p>
                            <h3 class="chronomots-display-title mt-2 text-2xl font-black tracking-[-0.05em] text-slate-950">Une structure prête pour grandir.</h3>
                        </div>
            ...
            <aside class="chronomots-panel rounded-[2rem] p-6 sm:p-8">
                ...
                <div class="mt-8 space-y-4">
                    <article class="chronomots-card-shell rounded-[1.75rem] p-5">
