    ...
    <x-slot name="header">
        <div class="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
            <div class="chronomots-heading-stack">
                <p class="chronomots-heading-eyebrow">Classements</p>
    ...
    <div class="px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <section class="chronomots-panel rounded-[2rem] p-6 sm:p-8">
                ...
                <h2 class="chronomots-display-title mt-6 text-3xl font-black tracking-[-0.06em] text-slate-950">Classement général</h2>
                <p class="chronomots-lead mt-4 max-w-2xl text-base leading-7 text-slate-600">
                            ...
                            <article class="chronomots-card-shell rounded-[1.6rem] p-5">
                                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <div class="grid gap-3 sm:grid-cols-3">
                                        <div class="chronomots-stat-card rounded-[1.2rem] px-4 py-3 text-center shadow-sm">
                                        ...
                                        <div class="chronomots-stat-card chronomots-stat-card--plum rounded-[1.2rem] px-4 py-3 text-center shadow-sm">
                                        ...
                                        <div class="chronomots-stat-card chronomots-stat-card--warm rounded-[1.2rem] px-4 py-3 text-center shadow-sm">
            ...
            <aside class="chronomots-panel rounded-[2rem] p-6 sm:p-8">
                ...
                <div class="mt-6 space-y-3">
                    @foreach ($ageHighlights as $highlight)
                        <div class="chronomots-card-shell rounded-[1.6rem] p-4">
